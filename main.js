...
function searchTextComponent () {
    ...
    if (query && count === 0) {
        return (
            `<h2 class="search-text margin-top--1 margin-bottom--4">No results for <strong>` + state.query + `</strong></h2>`
        )
    }

    if (!query) {
        return (
            `<h2 class="search-text margin-top--1 margin-bottom--4">No search query, showing all <strong>` + count +`</strong> results</h2>`
        )
    }

    return (
        `<h2 class="search-text margin-top--1 margin-bottom--4"><strong>` + count +`</strong> results found for <strong>` + query + `</strong>.</h2>`
    )
}

function resultItemComponent(data) {
    return (
        `<div class="result border-top--iron-lg">` +
            `<h3 class="result__title"><a href="">` + data.title + `</a></h3>` +
            `<p class="result__description">` + data.description + `</p>` +
